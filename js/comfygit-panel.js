...
function Sc(e, t, o = et) {
  const { immediate: n, deep: l, once: i, scheduler: r, augmentJob: u, call: d } = o, m = (x) => l ? x : zt(x) || l === !1 || l === 0 ? _s(x, 1) : _s(x);
  let v, h, w, p, _ = !1, S = !1;
  if ($t(e) ? (h = () => e.value, _ = zt(e)) : Xs(e) ? (h = () => m(e), _ = !0) : Ae(e) ? (S = !0, _ = e.some((x) => Xs(x) || zt(x)), h = () => e.map((x) => {
    if ($t(x))
      return x.value;
    if (Xs(x))
      return m(x);
  ...
  const T = (x) => {
    if (!(!(v.flags & 1) || !v.dirty && !x))
      if (t) {
        const q = v.run();
        if (l || _ || (S ? q.some((B, A) => Ns(B, N[A])) : Ns(q, N))) {
          w && w();
          const B = qs;
          qs = v;
          try {
...
const xi = Symbol("_vte"), Si = (e) => e.__isTeleport, Oo = (e) => e && (e.disabled || e.disabled === ""), il = (e) => e && (e.defer || e.defer === ""), rl = (e) => typeof SVGElement < "u" && e instanceof SVGElement, cl = (e) => typeof MathMLElement == "function" && e instanceof MathMLElement, pa = (e, t) => {
  ...
  process(e, t, o, n, l, i, r, u, d, m) {
    ...
    let { shapeFlag: N, children: T, dynamicChildren: x } = t;
    if (e == null) {
      ...
      const A = (E, O) => {
        ...
        const E = t.target = pa(t.props, _), O = Ei(E, t, S, p);
...
function jo(e, t, o, n, l) {
  const {
    ...
    onAfterAppear: N,
    onAppearCancelled: T
  } = t, x = String(e.key), q = Di(o, e), B = (E, O) => {
    E && es(
      E,
      n,
      9,
    ...
    leave(E, O) {
      ...
      let Y = !1;
      const H = E[ws] = (te) => {
        Y || (Y = !0, O(), te ? B(S, [E]) : B(_, [E]), E[ws] = void 0, q[re] === e && delete q[re]);
      };
      q[re] = e, p ? A(p, [E, H]) : H();
    },
    clone(E) {
...
function jc(e) {
  ...
  if (U(Nc, h), U(Qe, w), U(Ac, p), U(Ni, _), U(Dc, S), U(Lc, $), U(Bc, I), U(Fc, B), U(zc, A), U(Ai, N), U(wo, x), U(Uc, E), Ae(O))
    if (O.length) {
...
function gu(e, t) {
  ...
  const {
  ...
  } = e, S = (L, V, oe, ae = null, de = null, fe = null, ke = void 0, $e = null, ne = !!V.dynamicChildren) => {
    if (L === V)
      return;
    ...
    if (ne = L.el = r(
      ...
      for (const M in Re)
        M !== "value" && !Mo(M) && i(ne, M, null, Re[M], fe, ae);
    ...
    const $e = () => {
      if (L.isMounted) {
        let { next: Ce, bu: ee, u: K, parent: X, vnode: M } = L;
        {
          const rt = er(L);
          if (rt) {
            Ce && (Ce.el = M.el, z(L, Ce, ke)), rt.asyncDep.then(() => {
              L.isUnmounted || $e();
            });
            return;
          }
        ...
        let W = Ce, ce;
        js(L, !1), Ce ? (Ce.el = M.el, z(L, Ce, ke)) : Ce = M, ee && fn(ee), (ce = Ce.props && Ce.props.onVnodeBeforeUpdate) && ls(ce, X, Ce, M), js(L, !0);
        ...
        let Ce;
        const { el: ee, props: K } = V, { bm: X, m: M, parent: W, root: ce, type: Te } = L, Ke = fo(V);
        ...
        if (M && St(M, de), !Ke && (Ce = K && K.onVnodeMounted)) {
          const rt = V;
          St(
            () => ls(Ce, W, rt),
            de
    ...
    if (ue > Ce) {
      ...
      const K = ue, X = ue, M = /* @__PURE__ */ new Map();
      for (ue = X; ue <= ee; ue++) {
        const ct = V[ue] = ne ? Ls(V[ue]) : ds(V[ue]);
        ct.key != null && M.set(ct.key, ue);
      }
      let W, ce = 0;
      const Te = ee - X + 1;
      let Ke = !1, rt = 0;
      ...
      for (ue = K; ue <= Ce; ue++) {
        ...
        ft === void 0 ? De(ct, de, fe, !0) : (yt[ft - X] = ue + 1, ft >= rt ? rt = ft : Ke = !0, S(
          ct,
          V[ft],
          oe,
          null,
    ...
    const X = Re & 1 && ee, M = !fo(L);
    let W;
    if (M && (W = ke && ke.onVnodeBeforeUnmount) && ls(W, V, L), Re & 6)
    ...
    (M && (W = ke && ke.onVnodeUnmounted) || X) && St(() => {
  ...
  let ye = !1;
  const le = (L, V, oe) => {
    L == null ? V._vnode && De(V._vnode, null, null, !0) : S(
      V._vnode || null,
      L,
      V,
      null,
...
function y(e = "", t = !1) {
  return t ? (a(), D(_t, null, e)) : C(_t, null, e);
}
function ds(e) {
...
function cr(e) {
  ...
  const {
    ...
    Hs(Z, [H, U]), Sl(() => {
      Rs(H, Y ? d : i), rs(H, Y ? v : u), xl(Z) || Il(H, n, S, U);
    });
  };
  return mt(t, {
    onBeforeEnter(Y) {
...
const yd = { class: "panel-layout" }, wd = {
  ...
  setup(e) {
    ...
    const n = F(() => {
      ...
      return ((_ = (p = (w = t.status) == null ? void 0 : w.workflows) == null ? void 0 : p.synced) == null ? void 0 : _.filter((S) => {
        var P, N, T;
        const $ = (T = (N = (P = t.status) == null ? void 0 : P.workflows) == null ? void 0 : N.analyzed) == null ? void 0 : T.find((x) => x.name === S);
    ...
    return (w, p) => {
      var _, S, $, P, N, T, x, q, B, A, I, E, O, re, Y, H, te, Z, U, z, R, be;
      return a(), D(ht, { to: "body" }, [
        e.show ? (a(), c("div", {
          key: 0,
          class: "modal-overlay",
  ...
  setup(e, { expose: t, emit: o }) {
    ...
    const N = F(() => n.status.workflows.new.length > 0 || n.status.workflows.modified.length > 0 || n.status.workflows.deleted.length > 0), T = F(() => n.status.has_changes), x = F(() => {
    ...
    return (Z, U) => (a(), c(j, null, [
      C(Tt, null, {
        ...
        content: g(() => [
          n.setupState === "no_workspace" ? (a(), D(Ht, {
            key: 0,
            severity: "info",
            icon: "🚀",
            ...
            _: 1
          })) : n.setupState === "empty_workspace" ? (a(), D(Ht, {
            key: 2,
            severity: "info",
            icon: "🏗",
          ...
          s("div", {
            ...
            C(jd, {
              ...
              left: g(() => [
                e.status.workflows.new.length ? (a(), D(is, {
                  key: 0,
                  icon: "●",
                ...
                e.status.workflows.modified.length ? (a(), D(is, {
                  key: 1,
                  icon: "●",
                ...
                e.status.workflows.deleted.length ? (a(), D(is, {
                  key: 2,
                  icon: "●",
              ...
              right: g(() => [
                e.status.git_changes.nodes_added.length ? (a(), D(is, {
                  key: 0,
                  icon: "●",
                ...
                e.status.git_changes.nodes_removed.length ? (a(), D(is, {
                  key: 1,
                  icon: "●",
                ...
                e.status.git_changes.workflow_changes ? (a(), D(is, {
                  key: 2,
                  icon: "●",
                  count: B.value,
                ...
                T.value && !x.value && !A.value ? (a(), D(is, {
                  key: 4,
                  icon: "●",
          ...
          e.status.is_detached_head ? (a(), D(Ht, {
            key: 3,
            severity: "error",
            icon: "⚠",
          ...
          s("div", jm, [
            ...
            re.value ? (a(), c(j, { key: 0 }, [
              ...
              e.status.missing_models_count > 0 && !O.value ? (a(), D(Ht, {
                key: 2,
                severity: "warning",
                icon: "⚠",
              ...
              e.status.comparison.is_synced ? y("", !0) : (a(), D(Ht, {
                key: 3,
                severity: "error",
                icon: "⚠",
              ...
              e.status.has_legacy_manager ? (a(), D(Ht, {
                key: 4,
                severity: "warning",
                icon: "⚠",
            ...
            ], 64)) : q.value ? (a(), c("span", Hm, "No issues")) : (a(), D(ts, {
              key: 2,
              icon: "✅",
  ...
  setup(e, { emit: t }) {
    ...
    return (r, u) => (a(), D(Tt, null, {
      ...
      content: g(() => [
        ...
        e.branches.length === 0 ? (a(), D(ts, {
          key: 1,
          icon: "○",
          message: "No branches found"
        })) : (a(), c("div", iv, [
          (a(!0), c(j, null, ge(e.branches, (d) => (a(), D(lv, {
            key: d.name,
            "branch-name": d.name,
            "is-current": d.is_current
          }, {
            actions: g(() => [
              d.is_current ? y("", !0) : (a(), D(ie, {
                key: 0,
                variant: "destructive",
                size: "xs",
  ...
  setup(e) {
    return (t, o) => (a(), D(Tt, null, {
      header: g(() => [
        C(Pt, { title: "HISTORY" })
      ]),
      content: g(() => [
        e.commits.length === 0 ? (a(), D(ts, {
          key: 0,
          icon: "📜",
          message: "No commits yet"
        })) : (a(), D(fv, { key: 1 }, {
          default: g(() => [
            (a(!0), c(j, null, ge(e.commits, (n) => (a(), D(yv, {
              key: n.hash,
...
}), bv = /* @__PURE__ */ pe(wv, [["__scopeId", "data-v-981c3c64"]]), _T = Fs({
  hasWorkspace: !1,
  hasEnvironments: !1,
  isManaged: !1,
  hasLegacyManager: !1
                ...
                return a(), c("div", {
                  ...
                  O.status !== "available" ? (a(), c("div", ip, [
                    O.status === "downloadable" ? (a(), D(Me, {
                      ...
                      _: 1
                    })) : O.status === "category_mismatch" && O.file_path ? (a(), D(Me, {
                      key: 1,
                      variant: "secondary",
                      size: "sm",
                      ...
                      _: 1
                    }, 8, ["onClick"])) : O.status !== "path_mismatch" ? (a(), D(Me, {
                      key: 2,
                      variant: "secondary",
                      size: "sm",
...
const gp = { class: "resolution-stepper" }, hp = { class: "stepper-header" }, yp = ["onClick"], wp = {
  ...
  setup(e, { emit: t }) {
    ...
    const l = e, i = t, r = k(0), u = k(!1), d = k(!1), m = k(""), v = k(""), h = k(""), w = k([]), p = k(!1), _ = F(() => l.models[r.value]), S = F(() => l.models.some((z) => z.is_download_intent)), $ = F(() => l.models.filter(
    ...
    return (z, R) => {
      ...
      return a(), c("div", mh, [
        ...
        _.value ? (a(), D(yr, {
          ...
          onPrev: R[0] || (R[0] = (De) => x(r.value - 1)),
          onNext: R[1] || (R[1] = (De) => x(r.value + 1))
        }, null, 8, ["item-name", "current-index", "total-items"])) : y("", !0),
        _.value ? (a(), c("div", wh, [
          C(fh, {
  ...
  setup(e, { emit: t }) {
    const o = e, n = t, { analyzeWorkflow: l, applyResolution: i, installNodes: r, queueModelDownloads: u, progress: d, resetProgress: m } = hr(), { loadPendingDownloads: v } = en(), { openFileLocation: h } = at(), w = k(null), p = k(!1), _ = k(!1), S = k(null), $ = k("analysis"), P = k([]), N = k(/* @__PURE__ */ new Map()), T = k(/* @__PURE__ */ new Map()), x = k(/* @__PURE__ */ new Set()), q = F(() => {
      const X = [
      ...
      if (!w.value) return [];
      const X = w.value.nodes.resolved.filter((W) => !W.is_installed), M = /* @__PURE__ */ new Set();
      return X.filter((W) => M.has(W.package.package_id) ? !1 : (M.add(W.package.package_id), !0));
    }), Z = F(() => {
      if (!w.value) return [];
      const X = w.value.nodes.resolved.filter((W) => !W.is_installed), M = /* @__PURE__ */ new Map();
      for (const W of X) {
        const ce = M.get(W.package.package_id);
        ce ? ce.node_types_count++ : M.set(W.package.package_id, {
    ...
    }), U = F(() => te.value.filter((X) => !x.value.has(X.package.package_id))), z = F(() => w.value ? w.value.models.resolved.filter((X) => X.match_type === "download_intent").map((X) => ({
      ...
      const X = w.value.nodes.unresolved.map((W) => ({
        ...
        is_unresolved: !0,
        options: void 0
      })), M = w.value.nodes.ambiguous.map((W) => ({
        node_type: W.reference.node_type,
      ...
      const X = w.value.models.unresolved.map((W) => ({
        ...
        is_unresolved: !0,
        options: void 0
      })), M = w.value.models.ambiguous.map((W) => ({
        filename: W.reference.widget_value,
        reference: W.reference,
        has_multiple_options: !0,
        options: W.options.map((ce) => ({
      ...
      const X = be.value, M = z.value.map((W) => ({
        filename: W.filename,
        reference: W.reference,
        is_download_intent: !0,
      ...
      for (const M of N.value.values())
        M.action === "install" && X++;
      for (const M of T.value.values())
        M.action === "select" && X++;
      return X;
    }), De = F(() => {
      let X = 0;
      ...
      for (const M of R.value)
        N.value.has(M.node_type) || X++;
      for (const M of be.value)
        T.value.has(M.filename) || X++;
      return X;
    }), _e = F(() => {
      const X = {};
      if (X.analysis = { resolved: 1, total: 1 }, A.value) {
        const M = R.value.length, W = R.value.filter(
          (ce) => N.value.has(ce.node_type)
        ).length;
        X.nodes = { resolved: W, total: M };
      }
      if (I.value || E.value) {
        const M = ve.value.length, W = ve.value.filter(
          (ce) => T.value.has(ce.filename) || ce.is_download_intent
        ).length;
        X.models = { resolved: W, total: M };
      }
      if (X.review = { resolved: 1, total: 1 }, $.value === "applying") {
        const M = d.totalFiles || 1, W = d.completedFiles.length;
        X.applying = { resolved: W, total: M };
      }
      return X;
    });
    function Se(X) {
    ...
    function Ve() {
      const X = q.value.findIndex((M) => M.id === $.value);
    ...
    async function le() {
      ...
      try {
        ...
        S.value = X instanceof Error ? X.message : "Failed to analyze workflow";
      } finally {
        p.value = !1;
      }
    }
    ...
    function V(X, M) {
      ...
      (ce = W == null ? void 0 : W.options) != null && ce[M] && N.value.set(X, {
        action: "install",
        package_id: W.options[M].package_id
      });
    }
    function oe(X, M) {
      N.value.set(X, {
    ...
    function de(X) {
      x.value.has(X) ? x.value.delete(X) : x.value.add(X);
    }
    function fe(X) {
    ...
    function $e(X, M) {
      ...
      (ce = W == null ? void 0 : W.options) != null && ce[M] && T.value.set(X, {
        action: "select",
        selected_model: W.options[M].model
      });
    }
    function ne(X, M, W) {
      T.value.set(X, {
    ...
    async function Re(X) {
      try {
        ...
        S.value = M instanceof Error ? M.message : "Failed to open file location";
      }
    }
    async function Ce() {
      var X;
      ...
      try {
        const M = await i(o.workflowName, N.value, T.value, x.value);
        M.models_to_download && M.models_to_download.length > 0 && u(o.workflowName, M.models_to_download);
        const W = [
          ...M.nodes_to_install || [],
        ...
        S.value = M instanceof Error ? M.message : "Failed to apply resolution", d.error = S.value, d.phase = "error";
      } finally {
        _.value = !1;
      }
    }
    ...
    async function K() {
      var M;
      const X = ((M = d.nodeInstallProgress) == null ? void 0 : M.completedNodes.filter((W) => !W.success).map((W) => W.node_id)) || [];
      if (X.length !== 0) {
    ...
    return Qe(le), (X, M) => (a(), D(vt, {
      title: `Resolve Dependencies: ${e.workflowName}`,
      size: "lg",
      loading: p.value,
      error: S.value || void 0,
      "fixed-height": !0,
      onClose: M[1] || (M[1] = (W) => n("close"))
    }, {
      body: g(() => [
        p.value && !w.value ? (a(), c("div", hy, [...M[2] || (M[2] = [
          ...
          $.value === "analysis" ? (a(), c("div", wy, [
            s("div", by, [
              ...
              B.value ? (a(), c("div", Hy, [
                ...
                M[26] || (M[26] = s("span", { class: "status-icon" }, "⬇", -1)),
                ...
                s("div", s1, [
                  (a(!0), c(j, null, ge(Y.value, (W) => {
                    ...
                    return a(), c("div", {
                      ...
                      M[30] || (M[30] = s("span", { class: "mismatch-arrow" }, "→", -1)),
          ...
          $.value === "review" ? (a(), c("div", a1, [
            s("div", l1, [
              M[36] || (M[36] = s("div", { class: "review-header" }, [
              ...
              s("div", i1, [
                s("div", r1, [
                  ...
                  M[32] || (M[32] = s("span", { class: "stat-label" }, "to install", -1))
                ]),
                s("div", u1, [
                  s("span", d1, f(De.value), 1),
                  M[33] || (M[33] = s("span", { class: "stat-label" }, "to download", -1))
                ]),
                s("div", f1, [
                  s("span", m1, f(je.value), 1),
                  M[34] || (M[34] = s("span", { class: "stat-label" }, "optional", -1))
                ]),
                s("div", v1, [
                  s("span", p1, f(Je.value), 1),
                  M[35] || (M[35] = s("span", { class: "stat-label" }, "skipped", -1))
                ])
              ]),
              Z.value.length > 0 ? (a(), c("div", g1, [
                ...
                s("div", y1, [
                  (a(!0), c(j, null, ge(Z.value, (W) => (a(), c("div", {
                    ...
                    s("div", b1, [
                      x.value.has(W.package_id) ? (a(), c("span", k1, "Skipped")) : (a(), c("span", _1, "Will Install"))
                    ])
                  ]))), 128))
                ])
              ])) : y("", !0),
      ...
      footer: g(() => [
        $.value !== "analysis" && $.value !== "applying" ? (a(), D(Me, {
          key: 0,
          variant: "secondary",
          disabled: _.value,
          onClick: Ve
        ...
        M[41] || (M[41] = s("div", { class: "footer-spacer" }, null, -1)),
        $.value !== "applying" || Ue(d).phase === "complete" || Ue(d).phase === "error" ? (a(), D(Me, {
          key: 1,
          variant: "secondary",
          onClick: M[0] || (M[0] = (W) => n("close"))
        }, {
          default: g(() => [
...
}), H1 = /* @__PURE__ */ pe(j1, [["__scopeId", "data-v-20729feb"]]), K1 = { class: "search-input-wrapper" }, q1 = ["value", "placeholder"], Y1 = /* @__PURE__ */ me({
  __name: "SearchInput",
  props: {
    modelValue: {},
      ...
      C(Tt, null, {
        ...
        content: g(() => [
          r.value ? (a(), D(Is, {
            ...
            T.value.length ? (a(), D(ot, {
              key: 0,
              title: "BROKEN",
              count: T.value.length
            }, {
              default: g(() => [
                (a(!0), c(j, null, ge(T.value, (R) => (a(), D(Et, {
                  key: R.name,
                  status: "broken"
                }, {
                  icon: g(() => [...z[7] || (z[7] = [
            ...
            x.value.length ? (a(), D(ot, {
              key: 1,
              title: "NEW",
              count: x.value.length
            }, {
              default: g(() => [
                (a(!0), c(j, null, ge(x.value, (R) => (a(), D(Et, {
                  key: R.name,
            ...
            q.value.length ? (a(), D(ot, {
              key: 2,
              title: "MODIFIED",
              count: q.value.length
            }, {
              default: g(() => [
                (a(!0), c(j, null, ge(q.value, (R) => (a(), D(Et, {
                  key: R.name,
            ...
            B.value.length ? (a(), D(ot, {
              ...
              default: g(() => [
                (a(!0), c(j, null, ge(A.value, (R) => (a(), D(Et, {
                  key: R.name,
                ...
                !v.value && B.value.length > 5 ? (a(), D(ie, {
                  key: 0,
                  variant: "ghost",
                  size: "sm",
  ...
  emits: ["close"],
  setup(e, { emit: t }) {
    const o = e, { getModelDetails: n, addModelSource: l, removeModelSource: i, openFileLocation: r } = at(), u = k(null), d = k(!0), m = k(null), v = k(""), h = k(!1), w = k(null), p = k(null), _ = k(null), S = k(null);
    let $ = null;
      ...
      C(Tt, null, {
        ...
        content: g(() => [
          d.value ? (a(), D(Is, {
            ...
            (a(!0), c(j, null, ge(P.value, (E) => (a(), D(ot, {
              key: E.type,
              ...
              default: g(() => [
                (a(!0), c(j, null, ge(E.models, (O) => (a(), D(Et, {
                  key: O.hash || O.filename,
                  status: "synced"
                }, {
                  icon: g(() => [...I[4] || (I[4] = [
            ...
            $.value.length ? (a(), D(ot, {
              ...
              default: g(() => [
                (a(!0), c(j, null, ge($.value, (E) => (a(), D(Et, {
                  key: E.filename,
                  status: "broken"
                }, {
                  icon: g(() => [...I[6] || (I[6] = [
            ...
            !S.value.length && !$.value.length ? (a(), D(ts, {
              key: 2,
              icon: "📭",
  ...
  setup(e, { emit: t }) {
    ...
    } = at(), { addToQueue: r } = en(), u = t, d = k([]), m = k(!1), v = k(!1), h = k(null), w = k(""), p = k(!1), _ = k(null), S = k(!1), $ = k(null), P = k(""), N = k(!1), T = k(!1), x = k(""), q = k(""), B = k(null), A = F(
    ...
    async function H() {
      if (P.value.trim()) {
        ...
        try {
          ...
          $.value = z.path, S.value = !1, P.value = "", await Z(), console.log(`Directory changed: ${z.models_indexed} models indexed`), u("refresh");
        } catch (z) {
    ...
    return Qe(() => {
      ...
      C(Tt, null, {
        ...
        content: g(() => [
          m.value || B.value ? (a(), D(Is, {
            key: 0,
            message: B.value ? "Indexing models..." : "Loading workspace models..."
          }, null, 8, ["message"])) : h.value ? (a(), D(Es, {
            key: 1,
            message: h.value,
            retry: !0,
            onRetry: Z
          }, null, 8, ["message"])) : (a(), c(j, { key: 2 }, [
            d.value.length ? (a(), D(tn, {
              key: 0,
              variant: "compact"
            }, {
              default: g(() => [
            ...
            (a(!0), c(j, null, ge(E.value, (be) => (a(), D(ot, {
              key: be.type,
              ...
              default: g(() => [
                (a(!0), c(j, null, ge(be.models, (ve) => (a(), D(Et, {
      ...
      (a(), D(ht, { to: "body" }, [
        S.value ? (a(), c("div", {
          key: 0,
          class: "modal-overlay",
          onClick: R[9] || (R[9] = nt((be) => S.value = !1, ["self"]))
        }, [
          s("div", aw, [
            s("div", lw, [
          ...
          m.value ? (a(), D(Is, {
            ...
            x.value ? (a(), D(ot, {
              ...
              default: g(() => [
                ...
                (a(!0), c(j, null, ge(e.versionMismatches, (te) => (a(), D(Et, {
                  key: te.name,
                  status: "warning"
                }, {
                  icon: g(() => [...H[9] || (H[9] = [
            ...
            N.value.length ? (a(), D(ot, {
              ...
              default: g(() => [
                (a(!0), c(j, null, ge(N.value, (te) => (a(), D(Et, {
                  key: te.name,
                  status: "warning"
                }, {
                  icon: g(() => [...H[12] || (H[12] = [
            ...
            $.value.length ? (a(), D(ot, {
              ...
              default: g(() => [
                (a(!0), c(j, null, ge($.value, (te) => (a(), D(Et, {
                  key: te.name,
                  status: "synced"
                }, {
                  icon: g(() => [
            ...
            P.value.length ? (a(), D(ot, {
              ...
              default: g(() => [
                (a(!0), c(j, null, ge(P.value, (te) => (a(), D(Et, {
                  key: te.name,
                  status: "missing"
                }, {
                  icon: g(() => [...H[19] || (H[19] = [
            ...
            !$.value.length && !P.value.length && !N.value.length ? (a(), D(ts, {
              key: 5,
              icon: "📭",
...
const Jw = { class: "remote-url-display" }, Xw = ["title"], Qw = ["title"], Zw = {
  ...
  setup(e) {
    ...
    return (m, v) => (a(), D(Et, {
      ...
      r.value ? {
        name: "details",
        fn: g(() => [
          e.remote.push_url !== e.remote.fetch_url ? (a(), D(ut, {
            key: 0,
            label: "Push URL:"
          }, {
            default: g(() => [
        ...
        e.show ? (a(), c("div", {
          ...
          s("div", {
              ...
              e.error ? (a(), c("div", zb, [
                ...
                d.value ? (a(), c("div", Wb, [
                  ...
                  r.value > 0 ? (a(), c("details", Gb, [
                    ...
                    s("div", Hb, [
                      (a(!0), c(j, null, ge(e.preview.changes.workflows.added, (x) => (a(), c("div", {
                        key: "a-" + x,
                        class: "change-item add"
                      }, " + " + f(x), 1))), 128)),
                      (a(!0), c(j, null, ge(e.preview.changes.workflows.modified, (x) => (a(), c("div", {
                        key: "m-" + x,
                        class: "change-item modify"
                      }, [
                        b(" ~ " + f(x) + " ", 1),
                        _(x) ? (a(), c("span", Kb, "CONFLICT")) : y("", !0)
                      ]))), 128)),
                      (a(!0), c(j, null, ge(e.preview.changes.workflows.deleted, (x) => (a(), c("div", {
                        key: "d-" + x,
                  ...
                  u.value > 0 ? (a(), c("details", qb, [
                    ...
                    s("div", Jb, [
                      (a(!0), c(j, null, ge(e.preview.changes.nodes.to_install, (x) => (a(), c("div", {
                        key: x,
                        class: "change-item add"
                      }, " + " + f(x), 1))), 128))
                    ])
                  ...
                  e.preview.changes.models.count > 0 ? (a(), c("details", Xb, [
                    ...
                    s("div", Zb, [
                      (a(!0), c(j, null, ge(e.preview.changes.models.referenced, (x) => (a(), c("div", {
                        key: x,
                        class: "change-item"
                      }, f(x), 1))), 128))
                    ])
            ...
            s("div", l_, [
              ...
              ], 64)) : (T = e.preview) != null && T.has_uncommitted_changes ? (a(), D(ie, {
                key: 1,
                variant: "destructive",
                loading: e.pulling,
        ...
        e.show ? (a(), c("div", {
          ...
          s("div", {
            ...
            s("div", R_, [
              ...
              ], 64)) : e.preview && e.preview.commits_ahead > 0 && !e.preview.has_uncommitted_changes ? (a(), D(ie, {
                key: 1,
                variant: "primary",
                loading: e.pushing,
    ...
    return (w, p) => (a(), D(vt, {
      ...
      body: g(() => [
        s("div", X_, [
          ...
          s("div", ik, [
            (a(!0), c(j, null, ge(e.workflowConflicts, (_) => (a(), D(J_, {
              key: _.name,
              conflict: _,
              resolution: d(_.name),
      ...
      body: g(() => [
        s("div", Sk, [
          e.validation.is_compatible && e.validation.node_conflicts.length === 0 ? (a(), c("div", Ik, [
            ...
            s("div", Ek, [
              (a(!0), c(j, null, ge(e.validation.node_conflicts, (u) => (a(), D(xk, {
                key: u.node_id,
                conflict: u
              }, null, 8, ["conflict"]))), 128))
            ]),
  ...
  setup(e, { emit: t }) {
    const o = t, {
      ...
      pushToRemote: w,
      validateMerge: p
    } = at(), _ = k([]), S = k(null), $ = k({}), P = k(!1), N = k(null), T = k(""), x = k(!1), q = k(null), B = k(!1), A = k("add"), I = k({
      name: "",
      fetchUrl: "",
      pushUrl: ""
    }), E = F(() => {
    ...
    async function O() {
      ...
      try {
        const W = await n();
        _.value = W.remotes, S.value = W.current_branch_tracking || null, await Promise.all(
    ...
    return Qe(O), (W, ce) => (a(), c(j, null, [
      C(Tt, null, {
        header: g(() => [
          C(Pt, {
            title: "GIT REMOTES",
            "show-info": !0,
            onInfoClick: ce[0] || (ce[0] = (Te) => x.value = !0)
          }, {
            actions: g(() => [
              B.value ? y("", !0) : (a(), D(ie, {
                key: 0,
        ...
        content: g(() => [
          P.value ? (a(), D(Is, {
            ...
            _.value.length && !B.value ? (a(), D(tn, {
              key: 1,
              variant: "compact"
            }, {
              default: g(() => [
                b(" Total: " + f(_.value.length) + " remote" + f(_.value.length !== 1 ? "s" : "") + " ", 1),
                S.value ? (a(), c("span", Mk, " • Tracking: " + f(S.value.remote) + "/" + f(S.value.branch), 1)) : y("", !0)
              ]),
              _: 1
            })) : y("", !0),
            E.value.length && !B.value ? (a(), D(ot, {
              key: 2,
              title: "REMOTES",
              count: E.value.length
            }, {
              default: g(() => [
                (a(!0), c(j, null, ge(E.value, (Te) => (a(), D(fb, {
                  key: Te.name,
                  remote: Te,
      ...
      C(ss, {
        ...
        onClose: ce[2] || (ce[2] = (Te) => x.value = !1)
      }, {
        content: g(() => [...ce[5] || (ce[5] = [
  ...
  setup(e, { expose: t, emit: o }) {
    ...
    async function T() {
      ...
      try {
        const I = {};
        w.value !== (((B = h.value) == null ? void 0 : B.civitai_api_key) || "") && (I.civitai_api_key = w.value || null), p.value !== S(((A = h.value) == null ? void 0 : A.comfyui_extra_args) || []) && (I.comfyui_extra_args = $(p.value)), await r(I, n.workspacePath || void 0), await N(), m.value = { type: "success", message: "Settings saved successfully" }, l("saved"), setTimeout(() => {
          m.value = null;
        }, 3e3);
      } catch (I) {
        ...
        C(Pt, { title: "WORKSPACE SETTINGS" }, {
          actions: g(() => {
            ...
            return [
              ...
              (r = t.value) != null && r.hasChanges ? (a(), D(ie, {
                key: 0,
                variant: "ghost",
                size: "sm",
                onClick: l[1] || (l[1] = (u) => {
...
`);
    ...
    return Ct(r, () => {
      ...
      C(Tt, null, {
        ...
        content: g(() => [
          ...
          }, null, 8, ["message"])) : m.value ? (a(), D(Es, {
            key: 1,
            message: m.value,
            retry: !0,
            onRetry: S
          }, null, 8, ["message"])) : (a(), c(j, { key: 2 }, [
            u.value.length === 0 ? (a(), D(ts, {
              key: 0,
              icon: "📝",
              message: `No ${r.value} logs available`
            }, null, 8, ["message"])) : (a(), D(kr, {
              key: 1,
              logs: u.value,
    ...
    return (t, o) => (a(), D(Et, {
      ...
      e.showDetails ? {
        ...
        fn: g(() => [
          ...
          e.lastUsed && e.showLastUsed ? (a(), D(ut, {
            key: 0,
            label: "Last used:",
            value: e.lastUsed
          }, null, 8, ["value"])) : y("", !0)
      ...
      C(Tt, null, {
        ...
        content: g(() => [
          r.value ? (a(), D(Is, {
            ...
            w.value.length ? (a(), D(ot, {
              key: 0,
              title: "ENVIRONMENTS",
              count: w.value.length
            }, {
              default: g(() => [
                (a(!0), c(j, null, ge(w.value, (x) => (a(), D(p2, {
                  key: x.name,
  ...
  setup(e) {
    ...
    return (T, x) => (a(), c(j, null, [
              ...
              C(Et, {
                ...
                u.value.status === "success" ? {
                  ...
                  fn: g(() => [
                    ...
                    u.value.models_without_sources !== void 0 ? (a(), D(ut, {
                      key: 0,
                      label: "Models without sources:",
                      value: u.value.models_without_sources.toString()
                    }, null, 8, ["value"])) : y("", !0),
                    u.value.models_without_sources && u.value.models_without_sources > 0 ? (a(), c("div", B$, [...x[8] || (x[8] = [
                      s("span", { class: "warning-icon" }, "!", -1),
      ...
      v.value && m.value ? (a(), D(Sr, {
        key: 0,
        issues: m.value.blocking_issues,
        onClose: x[4] || (x[4] = (q) => v.value = !1)
      }, null, 8, ["issues"])) : y("", !0),
      h.value && m.value ? (a(), D(Ir, {
        key: 1,
  ...
  setup(e, { expose: t, emit: o }) {
    ...
    let h = null;
    const w = k(null), p = k(n.resumeImport ?? !1), _ = k(!1), S = k(!1), $ = k(""), P = k(!1), N = k(null), T = k(""), x = k(null), q = k(!1), B = k(null), A = k(null), I = k({
    ...
    }), H = F(() => !P.value && !N.value && A.value && I.value.name.length > 0 && !E.value && (w.value || x.value));
    ...
    function Z() {
      w.value = null, x.value = null, T.value = "", B.value = null, _.value = !1, S.value = !1, $.value = "", A.value = null, N.value = null, I.value = { name: "", modelStrategy: "required", torchBackend: "auto", switchAfterImport: !0 }, E.value = null, l("source-cleared");
    }
    function U() {
      ...
      const ye = async () => {
        try {
          ...
          return O.value = {
            ...
            error: Fe.error || null
          }, Fe.state === "complete" ? (De(), S.value = !0, $.value = `Environment '${Fe.environment_name}' created successfully`, p.value = !1, _.value = !0, Fe.environment_name && l("import-complete", Fe.environment_name, I.value.switchAfterImport), !1) : Fe.state === "error" ? (De(), S.value = !1, $.value = Fe.error || Fe.message, p.value = !1, _.value = !0, !1) : !0;
        } catch (Fe) {
    ...
    return Qe(async () => {
      ...
      var Fe;
      return a(), c("div", i3, [
        !w.value && !x.value && !p.value ? (a(), c("div", r3, [
          C(aC, {
        ...
        ])) : (w.value || x.value) && !p.value && !_.value ? (a(), c("div", m3, [
          s("div", v3, [
            w.value ? (a(), c("div", p3, [
          ...
          I.value.modelStrategy === "skip" && ((Fe = A.value) != null && Fe.models_needing_download) ? (a(), D(Ht, {
            key: 4,
            type: "warning",
          ...
          s("div", P3, [
            s("div", R3, f(S.value ? "Import Successful" : "Import Failed"), 1),
            s("div", M3, f($.value), 1)
          ]),
          s("div", D3, [
            C(ie, {
...
const U3 = { class: "instance-header" }, z3 = { class: "provider-badge" }, F3 = { class: "instance-name" }, B3 = {
  ...
  setup(e) {
    ...
    return (d, m) => (a(), c("div", {
      ...
      e.instance.status === "deploying" ? (a(), c("div", q3, [
        ...
        e.instance.deployment_progress ? (a(), D(jn, {
          key: 0,
          progress: e.instance.deployment_progress
        }, null, 8, ["progress"])) : y("", !0)
      ])) : y("", !0),
      s("div", J3, [
        e.instance.status === "running" && e.instance.comfyui_url ? (a(), D(ie, {
          key: 0,
          variant: "primary",
          size: "xs",
          onClick: i
        ...
        e.instance.console_url && e.instance.provider !== "custom" ? (a(), D(ie, {
          key: 1,
          variant: "ghost",
          size: "xs",
          onClick: r
        ...
        e.instance.status === "running" ? (a(), D(ie, {
          key: 2,
          variant: "secondary",
          size: "xs",
          loading: e.isLoading,
        ...
        e.instance.status === "stopped" ? (a(), D(ie, {
          key: 3,
          variant: "secondary",
          size: "xs",
          loading: e.isLoading,
  ...
  setup(e) {
    ...
    return (n, l) => (a(), c("div", Z3, [
      ...
      e.isLoading && e.instances.length === 0 ? (a(), c("div", t5, [...l[6] || (l[6] = [
        ...
        (a(!0), c(j, null, ge(o.value, (i) => (a(), D(Q3, {
          key: i.id,
          instance: i,
  ...
  setup(e) {
    ...
    return (i, r) => (a(), c("div", {
      ...
      s("div", h5, [
        ...
        e.syncStatus && e.syncStatus.ahead > 0 ? (a(), D(ie, {
          key: 0,
          variant: "primary",
          size: "xs",
          loading: e.isPushing,
          ...
          T.value ? (a(), D(ot, {
            ...
            default: g(() => [
              Z.value ? (a(), c("div", nx, "Loading remotes...")) : H.value.length === 0 ? (a(), c("div", ax, [
                ...
                s("div", lx, [
                  (a(!0), c(j, null, ge(H.value, (Le) => (a(), D(Pr, {
                    key: Le.name,
                    remote: Le,
  ...
  setup(e, { emit: t }) {
    const o = e, n = t, {
      ...
      getDeploySummary: d,
      deployToWorker: m
    } = at(), v = k([]), h = k({}), w = k(!1), p = k(null), _ = k(null), S = k(null), $ = k(o.worker.mode || "native"), P = k(""), N = k(null), T = k(!1), x = F(() => p.value && h.value[p.value] || null), q = F(() => {
        ...
        s("div", tS, [
          s("div", sS, [
            ...
            w.value ? (a(), c("div", oS, "Loading remotes...")) : v.value.length === 0 ? (a(), c("div", nS, [...te[6] || (te[6] = [
              ...
              (a(!0), c(j, null, ge(v.value, (Z) => (a(), D(Pr, {
                key: Z.name,
                remote: Z,
          ...
          x.value && x.value.ahead > 0 ? (a(), c("div", vS, [
  ...
  setup(e, { emit: t }) {
    const o = t, {
      ...
      scanForWorkers: r
    } = at(), u = k([]), d = k([]), m = k(!1), v = k(!1), h = k(null), w = k(!1), p = k(!1), _ = k(null), S = k(null);
    async function $() {
      m.value = !0;
      try {
        const A = await n();
    ...
    return Qe(() => {
      ...
      s("div", kS, [
        m.value && u.value.length === 0 ? (a(), c("div", $S, [...I[9] || (I[9] = [
          ...
          (a(!0), c(j, null, ge(u.value, (E) => (a(), D(w8, {
            key: E.name,
            worker: E,
      ...
      S.value ? (a(), c("div", {
        ...
        s("span", SS, f(S.value.type === "success" ? "✓" : "ⓘ"), 1),
        s("span", IS, f(S.value.message), 1),
        s("button", {
          class: "dismiss-btn",
...
const MS = { class: "settings-content" }, DS = { class: "settings-section" }, LS = {
  ...
  key: 3,
  class: "issues-error"
}, P4 = { class: "error-header" }, R4 = { class: "error-title" }, M4 = { class: "issues-list" }, D4 = { class: "workflow-state" }, L4 = { class: "message-section" }, O4 = { class: "popover-footer" }, N4 = {
  key: 1,
  class: "commit-popover"
}, A4 = { class: "popover-header" }, U4 = { class: "popover-body" }, z4 = {
  key: 0,
  class: "changes-summary"
}, F4 = {
  key: 0,
  ...
  key: 3,
  class: "issues-error"
}, Y4 = { class: "error-header" }, J4 = { class: "error-title" }, X4 = { class: "issues-list" }, Q4 = { class: "workflow-state" }, Z4 = { class: "message-section" }, e6 = { class: "popover-footer" }, t6 = /* @__PURE__ */ me({
  ...
  setup(e, { emit: t }) {
    ...
    return (_, S) => e.asModal ? (a(), D(ht, {
        ...
        s("div", {
          ...
          s("div", w4, [
            e.status && d.value ? (a(), c("div", b4, [
              ...
              m.value ? y("", !0) : (a(), c("div", S4, [...S[17] || (S[17] = [
            ...
            h.value ? (a(), c("div", T4, [
              s("div", P4, [
                ...
                s("span", R4, f(v.value.length) + " workflow(s) have issues", 1)
              ]),
              s("div", M4, [
      ...
      s("div", U4, [
        e.status && d.value ? (a(), c("div", z4, [
          e.status.workflows.new.length ? (a(), c("div", F4, [
            S[23] || (S[23] = s("span", { class: "change-icon new" }, "+", -1)),
            s("span", null, f(e.status.workflows.new.length) + " new workflow(s)", 1)
          ])) : y("", !0),
          e.status.workflows.modified.length ? (a(), c("div", B4, [
            S[24] || (S[24] = s("span", { class: "change-icon modified" }, "~", -1)),
            s("span", null, f(e.status.workflows.modified.length) + " modified", 1)
          ])) : y("", !0),
          e.status.workflows.deleted.length ? (a(), c("div", V4, [
            S[25] || (S[25] = s("span", { class: "change-icon deleted" }, "-", -1)),
            s("span", null, f(e.status.workflows.deleted.length) + " deleted", 1)
          ])) : y("", !0),
          e.status.git_changes.nodes_added.length ? (a(), c("div", W4, [
            S[26] || (S[26] = s("span", { class: "change-icon new" }, "+", -1)),
            s("span", null, f(e.status.git_changes.nodes_added.length) + " node(s) added", 1)
          ])) : y("", !0),
          e.status.git_changes.nodes_removed.length ? (a(), c("div", G4, [
            S[27] || (S[27] = s("span", { class: "change-icon deleted" }, "-", -1)),
            s("span", null, f(e.status.git_changes.nodes_removed.length) + " node(s) removed", 1)
          ])) : y("", !0),
          m.value ? y("", !0) : (a(), c("div", j4, [...S[28] || (S[28] = [
            s("span", { class: "change-icon modified" }, "~", -1),
            s("span", null, "Configuration updated", -1)
          ])]))
        ])) : e.status ? (a(), c("div", H4, " No changes to commit ")) : (a(), c("div", K4, " Loading... ")),
        h.value ? (a(), c("div", q4, [
          s("div", Y4, [
            S[29] || (S[29] = s("span", { class: "error-icon" }, "⚠", -1)),
            s("span", J4, f(v.value.length) + " workflow(s) have issues", 1)
          ]),
          s("div", X4, [
            (a(!0), c(j, null, ge(v.value, ($) => (a(), c("div", {
              key: $.name,
...
}), Mr = /* @__PURE__ */ pe(t6, [["__scopeId", "data-v-5f897631"]]), s6 = { class: "modal-header" }, o6 = { class: "modal-body" }, n6 = { class: "switch-message" }, a6 = { class: "switch-details" }, l6 = { class: "modal-actions" }, i6 = /* @__PURE__ */ me({
      ...
      e.show ? (a(), c("div", {
        ...
        s("div", {
          ...
          s("div", o6, [
            ...
            s("p", a6, ' Your current work will be preserved. You can switch back to "' + f(e.fromEnvironment) + '" anytime. ', 1),
...
}), r6 = /* @__PURE__ */ pe(i6, [["__scopeId", "data-v-e9c5253e"]]), c6 = {
  key: 0,
  class: "modal-overlay"
}, u6 = { class: "modal-content" }, d6 = { class: "modal-body" }, f6 = { class: "progress-info" }, m6 = { class: "progress-percentage" }, v6 = { class: "progress-state" }, p6 = { class: "switch-steps" }, g6 = { class: "step-icon" }, h6 = { class: "step-label" }, y6 = /* @__PURE__ */ me({
      ...
      e.show ? (a(), c("div", c6, [
        s("div", u6, [
          ...
          s("div", d6, [
            ...
            s("div", f6, [
              s("div", m6, f(e.progress) + "%", 1),
              s("div", v6, f(o.value), 1)
            ]),
            s("div", p6, [
              (a(!0), c(j, null, ge(l.value, (u) => (a(), c("div", {
                ...
                s("span", g6, f(u.icon), 1),
                s("span", h6, f(u.label), 1)
              ], 2))), 128))
            ]),
...
}), w6 = /* @__PURE__ */ pe(y6, [["__scopeId", "data-v-768a5078"]]), b6 = { class: "modal-header" }, _6 = { class: "modal-body" }, k6 = {
  key: 0,
  class: "node-section"
}, $6 = { class: "node-list" }, C6 = {
  key: 1,
  class: "node-section"
}, x6 = { class: "node-list" }, S6 = { class: "modal-actions" }, I6 = /* @__PURE__ */ me({
      ...
      e.show ? (a(), c("div", {
        ...
        s("div", {
          ...
          s("div", _6, [
            ...
            e.mismatchDetails.missing_nodes.length ? (a(), c("div", k6, [
            ...
            e.mismatchDetails.extra_nodes.length ? (a(), c("div", C6, [
...
}), E6 = /* @__PURE__ */ pe(I6, [["__scopeId", "data-v-7cad7518"]]), T6 = [
  {
    id: "sponsor",
...
], P6 = "v0.0.15", R6 = "Akatz", M6 = { class: "social-buttons" }, D6 = ["title", "aria-label", "onClick"], L6 = {
  width: "14",
  height: "14",
  viewBox: "0 0 16 16",
  fill: "currentColor"
}, O6 = ["d"], N6 = ["title", "aria-label", "onClick"], A6 = {
  width: "16",
  height: "16",
  viewBox: "0 0 16 16",
  fill: "currentColor"
  ...
  setup(e) {
    ...
    return (o, n) => (a(), c("div", M6, [
      (a(!0), c(j, null, ge(Ue(T6), (l) => (a(), c(j, {
        key: l.id
      }, [
        l.label ? (a(), c("button", {
          key: 0,
...
}), Dr = /* @__PURE__ */ pe(z6, [["__scopeId", "data-v-4f846342"]]), F6 = { class: "footer-info" }, B6 = { class: "version" }, V6 = { class: "made-by" }, W6 = /* @__PURE__ */ me({
  __name: "FooterInfo",
  setup(e) {
    return (t, o) => (a(), c("div", F6, [
      s("span", B6, f(Ue(P6)), 1),
      s("span", V6, [
...
}), Lr = /* @__PURE__ */ pe(W6, [["__scopeId", "data-v-8bc3db0a"]]), G6 = /* @__PURE__ */ me({
...
}), j6 = /* @__PURE__ */ pe(G6, [["__scopeId", "data-v-fac00ae7"]]), H6 = { class: "header-actions" }, K6 = {
  key: 0,
  class: "wizard-step"
}, q6 = { class: "form-field" }, Y6 = ["placeholder"], J6 = {
  key: 0,
  class: "form-error"
}, X6 = { class: "form-field form-field--checkbox" }, Q6 = { class: "form-checkbox" }, Z6 = {
  key: 0,
  class: "form-field"
}, eI = ["placeholder"], tI = {
  key: 0,
  ...
  key: 0,
  class: "cli-warning"
}, rI = { class: "cli-warning-header" }, cI = {
  key: 1,
  class: "env-landing"
}, uI = { class: "env-list" }, dI = ["value"], fI = { class: "env-name" }, mI = {
  key: 2,
  class: "env-create"
}, vI = { class: "form-field" }, pI = { class: "form-field" }, gI = ["value"], hI = { class: "form-field" }, yI = ["disabled"], wI = ["value"], bI = { class: "form-field" }, _I = ["value"], kI = { class: "form-field form-field--checkbox" }, $I = { class: "form-checkbox" }, CI = {
  key: 0,
  class: "form-error"
}, xI = {
  key: 1,
  class: "env-creating"
}, SI = { class: "creating-intro" }, II = {
  key: 3,
  class: "env-import"
}, EI = { class: "wizard-footer" }, TI = { class: "wizard-footer-actions" }, no = 10, PI = 600 * 1e3, ql = 1800 * 1e3, RI = /* @__PURE__ */ me({
  ...
  setup(e, { emit: t }) {
    const o = e, n = t, {
    ...
    } = at(), h = k(o.initialStep || 1), w = k(null), p = k("landing"), _ = k(!1), S = k(!1), $ = k(!1), P = k(!1), N = k(null), T = k(o.initialStep === 2), x = k(o.defaultPath), q = k(!!o.detectedModelsDir), B = k(o.detectedModelsDir || ""), A = k(null), I = k(null), E = k(null), O = k(null), re = k("my-new-env"), Y = k(Cr), H = k("latest"), te = k(xr), Z = k(!0), U = k(null), z = k(null), R = k([{ tag_name: "latest", name: "Latest", published_at: "" }]), be = k(!1), ve = k(!1), Ee = k(!1), De = k({ progress: 0, message: "" }), je = k({ progress: 0, message: "" }), Je = [
      { id: "init_structure", label: "Initialize structure", progressThreshold: 5 },
      { id: "resolve_version", label: "Resolve ComfyUI version", progressThreshold: 10 },
      { id: "clone_comfyui", label: "Clone/restore ComfyUI", progressThreshold: 25 },
      { id: "configure_environment", label: "Configure environment", progressThreshold: 30 },
      ...
      var M, W;
      const ee = (M = x.value) == null ? void 0 : M.trim(), K = !A.value, X = !q.value || !I.value && ((W = B.value) == null ? void 0 : W.trim());
      return ee && K && X;
    }), Fe = F(() => {
      var ee;
    ...
    async function ae() {
      ...
      if (A.value = null, I.value = null, await V(), (ee = A.value) != null && ee.includes("already exists")) {
        A.value = null, z.value = ((K = x.value) == null ? void 0 : K.trim()) || o.defaultPath, h.value = 2, fe();
        return;
      }
        ...
        try {
          ...
          const ce = setInterval(async () => {
            ...
            try {
              ...
              De.value = { progress: Ke.progress, message: Ke.message }, Ke.state === "complete" ? (clearInterval(ce), ve.value = !1, z.value = ((Te = x.value) == null ? void 0 : Te.trim()) || o.defaultPath, h.value = 2, fe()) : Ke.state === "error" && (clearInterval(ce), ve.value = !1, A.value = Ke.error || "Workspace creation failed");
            } catch (Ke) {
      ...
      try {
        ...
        if ((await u(ee)).status === "started") {
          ...
          const X = setInterval(async () => {
            ...
            try {
              const M = await d();
              if (Ve.value = 0, M.state === "idle" && Ee.value) {
              ...
              if (je.value = {
                ...
                const W = M.environment_name || ee.name;
                Z.value ? n("complete", W, z.value) : (p.value = "landing", n("environment-created-no-switch", W));
              } else M.state === "error" && (clearInterval(X), Ee.value = !1, U.value = M.error || "Environment creation failed");
            } catch (M) {
              Ve.value++, console.warn(`Polling failure ${Ve.value}/${no}:`, M), Ve.value >= no && (clearInterval(X), Ee.value = !1, U.value = "Lost connection to server. Please refresh and try again.");
            }
          }, 2e3);
        }
      } catch (ee) {
      ...
      const K = async () => {
        ...
        try {
          ...
          if (je.value = {
            ...
            const W = M.environment_name || re.value;
            return n("complete", W, z.value), !1;
          } else if (M.state === "error")
            return ee && clearInterval(ee), Ee.value = !1, U.value = M.error || "Environment creation failed", !1;
          return !0;
        } catch (M) {
          return Ve.value++, console.warn(`Polling failure ${Ve.value}/${no}:`, M), Ve.value >= no ? (ee && clearInterval(ee), Ee.value = !1, U.value = "Lost connection to server. Please refresh and try again.", !1) : !0;
        }
      };
          ...
          return [
            h.value === 1 ? (a(), c("div", K6, [
              ...
              s("div", q6, [
                ...
                He(s("input", {
                  "onUpdate:modelValue": K[2] || (K[2] = (M) => x.value = M),
                  type: "text",
                  class: "form-input",
                ...
                A.value ? (a(), c("p", J6, f(A.value), 1)) : y("", !0)
              ]),
              s("div", X6, [
                s("label", Q6, [
                  He(s("input", {
                    type: "checkbox",
                    "onUpdate:modelValue": K[3] || (K[3] = (M) => q.value = M)
                  }, null, 512), [
                    [Yo, q.value]
                  ]),
              ...
              q.value ? (a(), c("div", Z6, [
                ...
                He(s("input", {
                  "onUpdate:modelValue": K[4] || (K[4] = (M) => B.value = M),
                  type: "text",
                  class: "form-input",
                ...
                e.detectedModelsDir && !B.value ? (a(), c("p", tI, " Detected: " + f(e.detectedModelsDir), 1)) : y("", !0),
                E.value ? (a(), c("p", sI, " Did you mean: " + f(E.value), 1)) : y("", !0),
                I.value ? (a(), c("p", oI, f(I.value), 1)) : y("", !0),
                O.value !== null && !I.value ? (a(), c("p", nI, " Found " + f(O.value) + " model files ", 1)) : y("", !0)
              ])) : y("", !0),
              ve.value ? (a(), D(Pn, {
                key: 1,
              ...
              T.value ? (a(), c("div", lI, [...K[25] || (K[25] = [
                ...
                p.value === "landing" ? (a(), c("div", cI, [
                  ...
                  (X = o.existingEnvironments) != null && X.length ? (a(), c(j, { key: 0 }, [
                    ...
                    s("div", uI, [
                      (a(!0), c(j, null, ge(o.existingEnvironments, (M) => (a(), c("label", {
                        key: M,
                        class: xe(["env-option", { selected: w.value === M }])
                      }, [
                        He(s("input", {
                          type: "radio",
                          name: "env-select",
                  ...
                  Ee.value ? (a(), c("div", xI, [
                    ...
                    s("div", vI, [
                      ...
                      He(s("input", {
                        "onUpdate:modelValue": K[9] || (K[9] = (M) => re.value = M),
                        type: "text",
                        class: "form-input",
                    ...
                    s("div", pI, [
                      ...
                      He(s("select", {
                        "onUpdate:modelValue": K[10] || (K[10] = (M) => Y.value = M),
                        class: "form-select"
                      }, [
                        (a(!0), c(j, null, ge(Ue($r), (M) => (a(), c("option", {
                          key: M,
                          value: M
                        }, f(M), 9, gI))), 128))
                      ], 512), [
                    ...
                    s("div", hI, [
                      ...
                      He(s("select", {
                        "onUpdate:modelValue": K[11] || (K[11] = (M) => H.value = M),
                        class: "form-select",
                        disabled: be.value
                      }, [
                        (a(!0), c(j, null, ge(R.value, (M) => (a(), c("option", {
                          key: M.tag_name,
                          value: M.tag_name
                        }, f(M.name), 9, wI))), 128))
                      ], 8, yI), [
                    ...
                    s("div", bI, [
                      ...
                      He(s("select", {
                        "onUpdate:modelValue": K[12] || (K[12] = (M) => te.value = M),
                        class: "form-select"
                      }, [
                        (a(!0), c(j, null, ge(Ue(Ja), (M) => (a(), c("option", {
                          key: M,
                          value: M
                        }, f(M) + f(M === "auto" ? " (detect GPU)" : ""), 9, _I))), 128))
                      ], 512), [
                        [ms, te.value]
                      ])
                    ]),
                    s("div", kI, [
                      s("label", $I, [
                        He(s("input", {
                          type: "checkbox",
                          "onUpdate:modelValue": K[13] || (K[13] = (M) => Z.value = M)
                        }, null, 512), [
                          [Yo, Z.value]
                        ]),
                    ...
                    U.value ? (a(), c("div", CI, f(U.value), 1)) : y("", !0)
                  ], 64))
                ])) : p.value === "import" ? (a(), c("div", II, [
                  C(Er, {
                    "workspace-path": z.value,
                    "resume-import": P.value,
                    "initial-progress": N.value ?? void 0,
                    onImportComplete: ne,
                    onImportStarted: K[14] || (K[14] = (M) => S.value = !0),
                    onSourceCleared: ue
          ...
          s("div", EI, [
            ...
            s("div", TI, [
              h.value === 1 ? (a(), D(Me, {
                ...
                !Ee.value && !S.value && (p.value !== "landing" || o.setupState === "no_workspace" && !z.value) ? (a(), D(Me, {
                  key: 0,
                  variant: "secondary",
                  onClick: $e
                }, {
...
}), MI = /* @__PURE__ */ pe(RI, [["__scopeId", "data-v-9a9aadc0"]]), DI = { class: "comfygit-panel" }, LI = { class: "panel-header" }, OI = { class: "header-left" }, NI = {
  key: 0,
  class: "header-info"
}, AI = { class: "header-actions" }, UI = { class: "env-switcher" }, zI = {
  key: 0,
  class: "header-info"
}, FI = { class: "branch-name" }, BI = { class: "panel-main" }, VI = { class: "sidebar" }, WI = { class: "sidebar-content" }, GI = { class: "sidebar-section" }, jI = { class: "sidebar-section" }, HI = { class: "sidebar-section" }, KI = {
  key: 0,
  class: "sidebar-badge"
}, qI = { class: "sidebar-footer" }, YI = { class: "content-area" }, JI = {
  key: 0,
  class: "error-message"
}, XI = {
  key: 1,
  class: "loading"
}, QI = { class: "dialog-content env-selector-dialog" }, ZI = { class: "dialog-header" }, eE = { class: "dialog-body" }, tE = { class: "env-list" }, sE = { class: "env-info" }, oE = { class: "env-name-row" }, nE = { class: "env-indicator" }, aE = { class: "env-name" }, lE = {
  key: 0,
  class: "env-branch"
}, iE = {
  key: 1,
  class: "current-label"
}, rE = { class: "env-stats" }, cE = ["onClick"], uE = { class: "toast-container" }, dE = { class: "toast-message" }, fE = /* @__PURE__ */ me({
  ...
  setup(e, { emit: t }) {
    const o = e, n = t, {
      ...
      getSetupStatus: P
    } = at(), N = kv(), { liveInstanceCount: T } = Tr({ autoStart: !0 }), x = k(null), q = k([]), B = k([]), A = k([]), I = F(() => A.value.find((se) => se.is_current)), E = k(null), O = k(!1), re = k(1), Y = F(() => {
      var se;
    ...
    F(() => x.value ? Ce.value === "success" ? "All synced" : Ce.value === "warning" ? "Uncommitted changes" : Ce.value === "error" ? "Not synced" : "" : "");
    async function ee() {
      ...
      try {
        ...
        x.value = se, q.value = G.commits, B.value = Pe.branches, A.value = Be, n("statusUpdate", se), z.value && await z.value.loadWorkflows(!0);
      } catch (se) {
        te.value = se instanceof Error ? se.message : "Failed to load status", x.value = null, q.value = [], B.value = [];
      } finally {
        H.value = !1;
      }
    }
      ...
      return a(), c("div", DI, [
        ...
        s("div", UI, [
          ...
          s("button", {
            ...
            x.value ? (a(), c("div", zI, [
              s("span", null, f(((Pe = I.value) == null ? void 0 : Pe.name) || ((Be = x.value) == null ? void 0 : Be.environment) || "Loading..."), 1),
              s("span", FI, "(" + f(x.value.branch || "detached") + ")", 1)
            ])) : y("", !0),
        ...
        s("div", BI, [
            ...
            s("div", WI, [
              ...
              s("div", HI, [
                ...
                s("button", {
                  ...
                  Ue(T) > 0 ? (a(), c("span", KI, f(Ue(T)), 1)) : y("", !0)
                ], 2),
                s("button", {
          ...
          s("div", YI, [
            te.value ? (a(), c("div", JI, f(te.value), 1)) : !x.value && le.value === "status" ? (a(), c("div", XI, " Loading status... ")) : (a(), c(j, { key: 2 }, [
              le.value === "status" ? (a(), D(qm, {
                key: 0,
              ...
              }, null, 8, ["status", "setup-state"])) : le.value === "workflows" ? (a(), D(h0, {
                key: 1,
                ref_key: "workflowsSectionRef",
                ref: z,
                onRefresh: ee
              }, null, 512)) : le.value === "models-env" ? (a(), D(Z0, {
                key: 2,
                onNavigate: L
              })) : le.value === "branches" ? (a(), D(cv, {
                key: 3,
                branches: B.value,
                current: ((tt = x.value) == null ? void 0 : tt.branch) || null,
                onSwitch: M,
                onCreate: W,
                onDelete: ce
              }, null, 8, ["branches", "current"])) : le.value === "history" ? (a(), D(bv, {
                key: 4,
                commits: q.value,
                onSelect: K,
                onCheckout: X
              }, null, 8, ["commits"])) : le.value === "nodes" ? (a(), D(Yw, {
                key: 5,
                "version-mismatches": ((Rt = (dt = x.value) == null ? void 0 : dt.comparison) == null ? void 0 : Rt.version_mismatches) || [],
                onOpenNodeManager: oe,
                onRepairEnvironment: he,
                onToast: Re
              }, null, 8, ["version-mismatches"])) : le.value === "debug-env" ? (a(), D(u2, { key: 6 })) : le.value === "environments" ? (a(), D(m$, {
                key: 7,
                ...
                onCreated: Q,
                onDelete: We
              }, null, 512)) : le.value === "model-index" ? (a(), D(ww, {
                key: 8,
                onRefresh: ee
              })) : le.value === "settings" ? (a(), D(t2, { key: 9 })) : le.value === "debug-workspace" ? (a(), D(c2, { key: 10 })) : le.value === "deploy" ? (a(), D(GS, {
                key: 11,
                onToast: Re,
                onNavigate: L
              })) : le.value === "export" ? (a(), D(W$, { key: 12 })) : le.value === "import" ? (a(), D(N3, {
                key: 13,
                onImportCompleteSwitch: gs
              })) : le.value === "remotes" ? (a(), D(Lk, {
                key: 14,
                onToast: Re
              })) : y("", !0)
            ], 64))
            ...
            s("div", eE, [
              ...
              s("div", tE, [
                (a(!0), c(j, null, ge(A.value, (Ne) => (a(), c("div", {
                  ...
                  s("div", sE, [
                    s("div", oE, [
                      s("span", nE, f(Ne.is_current ? "●" : "○"), 1),
                      s("span", aE, f(Ne.name), 1),
                      Ne.current_branch ? (a(), c("span", lE, "(" + f(Ne.current_branch) + ")", 1)) : y("", !0),
                      Ne.is_current ? (a(), c("span", iE, "CURRENT")) : y("", !0)
                    ]),
                    s("div", rE, f(Ne.workflow_count) + " workflows • " + f(Ne.node_count) + " nodes ", 1)
                  ]),
...
}), mE = /* @__PURE__ */ pe(fE, [["__scopeId", "data-v-037b3ee3"]]), vE = { class: "item-header" }, pE = { class: "item-info" }, gE = { class: "filename" }, hE = { class: "metadata" }, yE = { class: "size" }, wE = {
  key: 0,
  class: "type"
}, bE = { class: "item-actions" }, _E = {
  key: 0,
  class: "progress-section"
}, kE = { class: "progress-bar" }, $E = { class: "progress-stats" }, CE = { class: "downloaded" }, xE = { class: "speed" }, SE = {
  key: 0,
  class: "eta"
}, IE = {
  key: 1,
  ...
  setup(e, { emit: t }) {
    ...
    return (r, u) => (a(), c("div", {
      ...
      s("div", vE, [
        s("div", pE, [
          s("div", gE, f(e.item.filename), 1),
          s("div", hE, [
            s("span", yE, f(n(e.item.size)), 1),
            e.item.type ? (a(), c("span", wE, f(e.item.type), 1)) : y("", !0)
          ])
        ]),
        s("div", bE, [
      ...
      e.item.status === "downloading" ? (a(), c("div", _E, [
        s("div", kE, [
          s("div", {
            class: "progress-fill",
        ...
        s("div", $E, [
          s("span", CE, f(n(e.item.downloaded)) + " / " + f(n(e.item.size)), 1),
          s("span", xE, f(l(e.item.speed)), 1),
          e.item.eta > 0 ? (a(), c("span", SE, f(i(e.item.eta)), 1)) : y("", !0)
        ])
      ])) : e.item.status === "paused" ? (a(), c("div", IE, " Paused - click Resume to download ")) : e.item.status === "queued" ? (a(), c("div", EE, " Waiting in queue... ")) : e.item.status === "completed" ? (a(), c("div", TE, " ✓ Downloaded ")) : e.item.status === "failed" ? (a(), c("div", PE, [
        b(" ✗ " + f(e.item.error || "Failed") + " ", 1),
        e.item.retries > 0 ? (a(), c("span", RE, "(" + f(e.item.retries) + " retries)", 1)) : y("", !0)
      ])) : y("", !0)
    ], 2));
  }
}), Eo = /* @__PURE__ */ pe(ME, [["__scopeId", "data-v-2110df65"]]), DE = { class: "queue-title" }, LE = { class: "count" }, OE = { class: "queue-actions" }, NE = { class: "action-label" }, AE = {
  key: 0,
  class: "overall-progress"
}, UE = { class: "progress-bar" }, zE = {
  key: 0,
  class: "current-mini"
}, FE = { class: "filename" }, BE = { class: "speed" }, VE = {
  key: 1,
  class: "queue-content"
}, WE = {
  key: 0,
  ...
  key: 1,
  class: "section"
}, jE = { class: "section-header" }, HE = { class: "section-label paused" }, KE = { class: "items-list" }, qE = {
  key: 2,
  class: "section"
}, YE = { class: "section-header" }, JE = { class: "section-label" }, XE = { class: "items-list" }, QE = {
  key: 3,
  class: "section"
}, ZE = { class: "section-header" }, eT = { class: "section-label" }, tT = { class: "items-list" }, sT = {
  key: 4,
  class: "section"
}, oT = { class: "section-header" }, nT = { class: "section-label failed" }, aT = { class: "items-list" }, lT = /* @__PURE__ */ me({
      ...
      Ue(u) ? (a(), c("div", {
        ...
        s("div", {
          ...
          s("div", DE, [
            ...
            s("span", LE, "(" + f(Ue(d)) + "/" + f(Ue(t).items.length) + ")", 1)
          ]),
          s("div", OE, [
            s("span", NE, f(S.value ? "minimize" : "expand"), 1)
          ])
        ]),
        S.value ? (a(), c("div", VE, [
          Ue(o) ? (a(), c("div", WE, [
          ...
          Ue(r).length > 0 ? (a(), c("div", GE, [
            s("div", jE, [
              s("span", HE, "Paused (" + f(Ue(r).length) + ")", 1),
              s("button", {
          ...
          Ue(n).length > 0 ? (a(), c("div", qE, [
            s("div", YE, [
              s("span", JE, "Queued (" + f(Ue(n).length) + ")", 1)
            ]),
            s("div", XE, [
              (a(!0), c(j, null, ge(Ue(n), (B) => (a(), D(Eo, {
                key: B.id,
                item: B,
                onCancel: (A) => N(B.id)
          ...
          Ue(l).length > 0 ? (a(), c("div", QE, [
            s("div", ZE, [
              s("span", eT, "Completed (" + f(Ue(l).length) + ")", 1),
              s("button", {
                class: "clear-btn",
            ...
            s("div", tT, [
              (a(!0), c(j, null, ge(Ue(l).slice(0, 3), (B) => (a(), D(Eo, {
                key: B.id,
                item: B,
                onRemove: (A) => Ue(p)(B.id)
          ...
          Ue(i).length > 0 ? (a(), c("div", sT, [
            s("div", oT, [
              s("span", nT, "Failed (" + f(Ue(i).length) + ")", 1)
            ]),
            s("div", aT, [
              (a(!0), c(j, null, ge(Ue(i), (B) => (a(), D(Eo, {
                key: B.id,
                item: B,
                onRetry: (A) => Ue(v)(B.id),
                onRemove: (A) => Ue(p)(B.id)
...
function Ar(e = Xa) {
  Ks && Ks.remove(), Ks = document.createElement("style"), Ks.id = "comfygit-theme-styles", Ks.setAttribute("data-theme", e), Ks.textContent = uT[e], document.head.appendChild(Ks), document.body.setAttribute("data-comfygit-theme", e), Nr = e;
  try {
...
window.ComfyGit = {
  setTheme: (e) => {
    console.log(`[ComfyGit] Switching to theme: ${e}`), mT(e);
  },
  getTheme: () => {
    const e = fT();
...
function hT(e) {
  ...
  document.addEventListener("keydown", n), Fo = Ka({
    render: () => Wn(Mr, {
      ...
      onClose: Po,
      onCommitted: (l) => {
        Po(), yT(l.success, l.message), yn().then(Bo);
      }
    })
...
Os.registerExtension({
  ...
  async setup() {
    ...
    t.className = "comfyui-button comfyui-menu-mobile-collapse comfygit-panel-btn", t.textContent = "ComfyGit", t.title = "ComfyGit Control Panel", t.onclick = Jl, Ut = document.createElement("button"), Ut.className = "comfyui-button comfyui-menu-mobile-collapse comfygit-commit-btn", Ut.innerHTML = 'Commit <span class="commit-indicator"></span>', Ut.title = "Quick Commit", Ut.onclick = () => hT(Ut), e.appendChild(t), e.appendChild(Ut), (i = (l = Os.menu) == null ? void 0 : l.settingsGroup) != null && i.element && (Os.menu.settingsGroup.element.before(e), console.log("[ComfyGit] Control Panel buttons added to toolbar")), wT();
