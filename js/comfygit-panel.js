...
function gu(e, s) {
  ...
  const {
    ...
    let ne, ce;
    const { props: Re, shapeFlag: Ce, transition: Z, dirs: K } = L;
    if (ne = L.el = r(
      L.type,
      de,
      Re && Re.is,
    ...
    const Te = hu(ue, Z);
    Te && Z.beforeEnter(ne), n(ne, W, oe), ((ce = Re && Re.onVnodeMounted) || Te || K) && St(() => {
      ce && ls(ce, ae, L), Te && Z.enter(ne), K && Gs(L, null, ae, "mounted");
    }, ue);
  }, A = (L, W, oe, ae, ue) => {
    if (oe && p(L, oe), ae)
    ...
    ne |= L.patchFlag & 16;
    const Ce = L.props || tt, Z = W.props || tt;
    let K;
    if (oe && js(oe, !1), (K = Z.onVnodeBeforeUpdate) && ls(K, oe, W, L), Re && Gs(W, L, oe, "beforeUpdate"), oe && js(oe, !0), (Ce.innerHTML && Z.innerHTML == null || Ce.textContent && Z.textContent == null) && v($e, ""), ce ? O(
      L.dynamicChildren,
      ce,
      $e,
      oe,
      ...
      if (ne & 16)
        re($e, Ce, Z, oe, ue);
      else if (ne & 2 && Ce.class !== Z.class && i($e, "class", null, Z.class, ue), ne & 4 && i($e, "style", Ce.style, Z.style, ue), ne & 8) {
        const Te = W.dynamicProps;
        for (let ge = 0; ge < Te.length; ge++) {
          const F = Te[ge], D = Ce[F], ee = Z[F];
          (ee !== D || F === "value") && i($e, F, D, ee, ue, oe);
        }
      }
      ne & 1 && L.children !== W.children && v($e, W.children);
    } else !ke && ce == null && re($e, Ce, Z, oe, ue);
    ((K = Z.onVnodeUpdated) || Re) && St(() => {
    ...
    let { patchFlag: Ce, dynamicChildren: Z, slotScopeIds: K } = W;
    K && ($e = $e ? $e.concat(K) : K), L == null ? (n(ce, oe, ae), n(Re, oe, ae), I(
      ...
      $e,
      ne
    )) : Ce > 0 && Ce & 64 && Z && // #2715 the previous fragment could've been a BAILed one as a result
    ...
    const $e = () => {
      if (L.isMounted) {
        let { next: Ce, bu: Z, u: K, parent: Te, vnode: ge } = L;
        {
          const Ye = er(L);
          if (Ye) {
        ...
        let F = Ce, D;
        js(L, !1), Ce ? (Ce.el = ge.el, z(L, Ce, ke)) : Ce = ge, Z && fn(Z), (D = Ce.props && Ce.props.onVnodeBeforeUpdate) && ls(D, Te, Ce, ge), js(L, !0);
        const ee = hl(L), Me = L.subTree;
        L.subTree = ee, S(
          Me,
          ee,
          ...
          ue,
          de
        ), Ce.el = ee.el, F === null && ru(L, ee.el), K && St(K, ue), (D = Ce.props && Ce.props.onVnodeUpdated) && St(
          () => ls(D, Te, Ce, ge),
          ue
        );
      } else {
        let Ce;
        const { el: Z, props: K } = W, { bm: Te, m: ge, parent: F, root: D, type: ee } = L, Me = fo(W);
        js(L, !1), Te && fn(Te), !Me && (Ce = K && K.onVnodeBeforeMount) && ls(Ce, F, W), js(L, !0);
        {
          D.ce && // @ts-expect-error _def is private
          D.ce._def.shadowRoot !== !1 && D.ce._injectChildStyle(ee);
    ...
    const ce = L && L.children, Re = L ? L.shapeFlag : 0, Ce = W.children, { patchFlag: Z, shapeFlag: K } = W;
    if (Z > 0) {
      if (Z & 128) {
        me(
          ce,
    ...
    for (; ce <= Ce && ce <= Z; ) {
      const K = L[Ce], Te = W[Z] = ne ? Ls(W[Z]) : ds(W[Z]);
      if (Ys(K, Te))
        S(
          K,
          Te,
    ...
    if (ce > Ce) {
      ...
      for (F = vt.length - 1, ce = ee - 1; ce >= 0; ce--) {
    ...
    if (ae !== 2 && ce & 1 && $e)
      if (ae === 0)
        ...
        const { leave: Ce, delayLeave: Z, afterLeave: K } = $e, Te = () => {
...
const gp = { class: "resolution-stepper" }, hp = { class: "stepper-header" }, yp = ["onClick"], wp = {
  ...
  setup(e, { emit: s }) {
    const o = e, n = s, { analyzeWorkflow: l, applyResolution: i, installNodes: r, queueModelDownloads: u, progress: d, resetProgress: m } = hr(), { loadPendingDownloads: v } = en(), { openFileLocation: h } = lt(), w = k(null), p = k(!1), _ = k(!1), S = k(null), $ = k("analysis"), P = k([]), N = k(/* @__PURE__ */ new Map()), T = k(/* @__PURE__ */ new Map()), x = k(/* @__PURE__ */ new Set()), q = B(() => {
      ...
      if (!w.value) return [];
      const F = w.value.nodes.resolved.filter((ee) => !ee.is_installed), D = /* @__PURE__ */ new Set();
      return F.filter((ee) => D.has(ee.package.package_id) ? !1 : (D.add(ee.package.package_id), !0));
    }), Q = B(() => {
      if (!w.value) return [];
      const F = w.value.nodes.resolved.filter((ee) => !ee.is_installed), D = /* @__PURE__ */ new Map();
      for (const ee of F) {
        const Me = D.get(ee.package.package_id);
        Me ? Me.node_types_count++ : D.set(ee.package.package_id, {
      ...
      if (!w.value) return [];
      const F = w.value.nodes.unresolved.map((ee) => ({
        node_type: ee.reference.node_type,
        reason: ee.reason,
        is_unresolved: !0,
        options: void 0
      })), D = w.value.nodes.ambiguous.map((ee) => ({
        node_type: ee.reference.node_type,
      ...
      if (!w.value) return [];
      const F = w.value.models.unresolved.map((ee) => ({
        filename: ee.reference.widget_value,
        reference: ee.reference,
        reason: ee.reason,
        is_unresolved: !0,
        options: void 0
      })), D = w.value.models.ambiguous.map((ee) => ({
        filename: ee.reference.widget_value,
        reference: ee.reference,
        has_multiple_options: !0,
        options: ee.options.map((Me) => ({
      ...
      const F = be.value, D = z.value.map((ee) => ({
    ...
    const He = B(() => {
      ...
      if (F.analysis = { resolved: 1, total: 1 }, A.value) {
        const D = R.value.length, ee = R.value.filter(
          (Me) => N.value.has(Me.node_type)
        ).length;
        F.nodes = { resolved: ee, total: D };
      }
      if (I.value || E.value) {
        const D = me.value.length, ee = me.value.filter(
          (Me) => T.value.has(Me.filename) || Me.is_download_intent
        ).length;
        F.models = { resolved: ee, total: D };
      }
      if (F.review = { resolved: 1, total: 1 }, $.value === "applying") {
        const D = d.totalFiles || 1, ee = d.completedFiles.length;
        F.applying = { resolved: ee, total: D };
      }
      return F;
    });
    function ye(F) {
    ...
    function ae(F, D) {
      var Me;
      const ee = R.value.find((Ye) => Ye.node_type === F);
      (Me = ee == null ? void 0 : ee.options) != null && Me[D] && N.value.set(F, {
        action: "install",
    ...
    function ce(F, D) {
      var Me;
      const ee = be.value.find((Ye) => Ye.filename === F);
      (Me = ee == null ? void 0 : ee.options) != null && Me[D] && T.value.set(F, {
        action: "select",
    ...
    async function K() {
      ...
      try {
        ...
        d.nodesToInstall = [...new Set(ee)], d.nodesToInstall.length > 0 && await r(o.workflowName), d.phase = "complete", await v();
    ...
    async function ge() {
      var D;
      const F = ((D = d.nodeInstallProgress) == null ? void 0 : D.completedNodes.filter((ee) => !ee.success).map((ee) => ee.node_id)) || [];
      if (F.length !== 0) {
        ...
        try {
          ...
          d.error = ee instanceof Error ? ee.message : "Retry failed", d.phase = "error";
        }
      }
    }
          ...
          $.value === "analysis" ? (a(), c("div", wy, [
            t("div", by, [
              ...
              H.value ? (a(), c("div", t1, [
                ...
                t("div", s1, [
                  (a(!0), c(j, null, pe(Y.value, (ee) => {
                    var Me, Ye;
                    return a(), c("div", {
                      key: ee.reference.widget_value,
                      class: "mismatch-item"
                    }, [
                      t("code", o1, f(ee.actual_category) + "/" + f((Me = ee.model) == null ? void 0 : Me.filename), 1),
                      D[30] || (D[30] = t("span", { class: "mismatch-arrow" }, "→", -1)),
                      t("code", n1, f((Ye = ee.expected_categories) == null ? void 0 : Ye[0]) + "/", 1),
                      ee.file_path ? (a(), M(De, {
                        key: 0,
                        variant: "ghost",
                        size: "sm",
                        onClick: (mt) => Z(ee.file_path)
                      }, {
                        default: g(() => [...D[29] || (D[29] = [
                          b(" Open File Location ", -1)
                        ])]),
          ...
          $.value === "review" ? (a(), c("div", a1, [
            t("div", l1, [
              ...
              Q.value.length > 0 ? (a(), c("div", g1, [
                ...
                t("div", y1, [
                  (a(!0), c(j, null, pe(Q.value, (ee) => (a(), c("div", {
                    key: ee.package_id,
                    class: "review-item"
                  }, [
                    t("code", w1, f(ee.package_id), 1),
                    t("div", b1, [
                      x.value.has(ee.package_id) ? (a(), c("span", k1, "Skipped")) : (a(), c("span", _1, "Will Install"))
                    ])
                  ]))), 128))
                ])
              ])) : y("", !0),
              R.value.length > 0 ? (a(), c("div", $1, [
                ...
                t("div", x1, [
                  (a(!0), c(j, null, pe(R.value, (ee) => {
                    var Me, Ye, mt, vt;
                    return a(), c("div", {
                      key: ee.node_type,
                      class: "review-item"
                    }, [
                      t("code", S1, f(ee.node_type), 1),
                      t("div", I1, [
                        N.value.has(ee.node_type) ? (a(), c(j, { key: 0 }, [
                          ((Me = N.value.get(ee.node_type)) == null ? void 0 : Me.action) === "install" ? (a(), c("span", E1, f((Ye = N.value.get(ee.node_type)) == null ? void 0 : Ye.package_id), 1)) : ((mt = N.value.get(ee.node_type)) == null ? void 0 : mt.action) === "optional" ? (a(), c("span", T1, " Optional ")) : ((vt = N.value.get(ee.node_type)) == null ? void 0 : vt.action) === "skip" ? (a(), c("span", P1, " Skip ")) : y("", !0)
              ...
              Ee.value.length > 0 ? (a(), c("div", M1, [
                ...
                t("div", L1, [
                  (a(!0), c(j, null, pe(Ee.value, (ee) => (a(), c("div", {
                    key: ee.filename,
                    class: "review-item download-item"
                  }, [
                    t("div", O1, [
                      t("code", N1, f(ee.filename), 1),
                      t("div", A1, [
                        t("span", U1, "→ " + f(ee.target_path), 1),
                        ee.url ? (a(), c("span", {
                          key: 0,
                          class: "download-url",
                          title: ee.url
                        }, f(Le(ee.url)), 9, z1)) : y("", !0)
                      ])
                    ]),
              ...
              me.value.length > 0 ? (a(), c("div", F1, [
                ...
                t("div", V1, [
                  (a(!0), c(j, null, pe(me.value, (ee) => {
                    var Me, Ye, mt, vt, ct, ut, Rt;
                    return a(), c("div", {
                      key: ee.filename,
                      class: "review-item"
                    }, [
                      t("code", W1, f(ee.filename), 1),
                      t("div", G1, [
                        T.value.has(ee.filename) ? (a(), c(j, { key: 0 }, [
                          ((Me = T.value.get(ee.filename)) == null ? void 0 : Me.action) === "select" ? (a(), c("span", j1, f((mt = (Ye = T.value.get(ee.filename)) == null ? void 0 : Ye.selected_model) == null ? void 0 : mt.filename), 1)) : ((vt = T.value.get(ee.filename)) == null ? void 0 : vt.action) === "download" ? (a(), c("span", H1, " Download ")) : ((ct = T.value.get(ee.filename)) == null ? void 0 : ct.action) === "optional" ? (a(), c("span", K1, " Optional ")) : ((ut = T.value.get(ee.filename)) == null ? void 0 : ut.action) === "skip" ? (a(), c("span", q1, " Skip ")) : ((Rt = T.value.get(ee.filename)) == null ? void 0 : Rt.action) === "cancel_download" ? (a(), c("span", Y1, " Cancel Download ")) : y("", !0)
                        ], 64)) : ee.is_download_intent ? (a(), c("span", J1, " Pending Download ")) : (a(), c("span", X1, " No action (skipped) "))
                      ])
                    ]);
                  }), 128))
                ])
...
}), e0 = /* @__PURE__ */ ve(Z1, [["__scopeId", "data-v-cb78ed13"]]), t0 = { class: "search-input-wrapper" }, s0 = ["value", "placeholder"], o0 = /* @__PURE__ */ fe({
  __name: "SearchInput",
  props: {
    modelValue: {},
...
const nb = { class: "remote-url-display" }, ab = ["title"], lb = ["title"], ib = {
  ...
  setup(e, { emit: s }) {
    ...
    function Y(F) {
      const D = _.value.find((ee) => ee.name === F);
    ...
    async function ae(F) {
      ...
      const D = _e.value;
      try {
        const ee = await v(D, F);
        if (ee.rolled_back) {
          ye.value = `Pull failed and was rolled back: ${ee.error || "Unknown error"}`, R.value = "pull_preview";
          return;
        }
        Ce(), R.value = "idle", o("toast", `✓ Pulled from ${D}`, "success"), await O();
      } catch (ee) {
        ye.value = ee instanceof Error ? ee.message : "Pull failed", R.value = "pull_preview";
      }
    }
    function ue() {
    ...
    async function ne() {
      ...
      const F = _e.value;
      try {
        const D = Array.from(le.value.values()), ee = await v(F, {
      ...
      C(Tt, null, {
        header: g(() => [
          C(Pt, {
            title: "GIT REMOTES",
            "show-info": !0,
            onInfoClick: D[0] || (D[0] = (ee) => x.value = !0)
          }, {
            actions: g(() => [
              V.value ? y("", !0) : (a(), M(ie, {
                key: 0,
        ...
        search: g(() => [
          V.value ? y("", !0) : (a(), M(bo, {
            key: 0,
            modelValue: T.value,
            "onUpdate:modelValue": D[1] || (D[1] = (ee) => T.value = ee),
        ...
        content: g(() => [
          P.value ? (a(), M(Is, {
            ...
            E.value.length && !V.value ? (a(), M(nt, {
              ...
              default: g(() => [
                (a(!0), c(j, null, pe(E.value, (ee) => (a(), M(bb, {
                  key: ee.name,
                  remote: ee,
...
const FS = { class: "settings-content" }, BS = { class: "settings-section" }, VS = {
  ...
  setup(e, { emit: s }) {
    const o = e, n = s, {
      ...
      var ge, F;
      const Z = (ge = x.value) == null ? void 0 : ge.trim(), K = !A.value, Te = !q.value || !I.value && ((F = V.value) == null ? void 0 : F.trim());
      return Z && K && Te;
    }), Fe = B(() => {
      var Z;
    ...
    async function oe() {
      var Z;
      if (I.value = null, E.value = null, O.value = null, !!((Z = V.value) != null && Z.trim()))
        try {
    ...
    async function ae() {
      var Z, K, Te, ge, F;
      if (A.value = null, I.value = null, await W(), (Z = A.value) != null && Z.includes("already exists")) {
        ...
        try {
          ...
          const D = setInterval(async () => {
            ...
            try {
              ...
              Le.value = { progress: Me.progress, message: Me.message }, Me.state === "complete" ? (clearInterval(D), me.value = !1, z.value = ((ee = x.value) == null ? void 0 : ee.trim()) || o.defaultPath, h.value = 2, de()) : Me.state === "error" && (clearInterval(D), me.value = !1, A.value = Me.error || "Workspace creation failed");
            } catch (Me) {
    ...
    async function ue() {
      ...
      try {
          ...
          const Te = setInterval(async () => {
            ...
            try {
              ...
              if (He.value = {
                ...
                const F = ge.environment_name || Z.name;
        ...
        Ee.value = !1, U.value = Z instanceof Error ? Z.message : "Unknown error";
      }
    }
    async function de() {
      be.value = !0;
    ...
    function ne(Z, K) {
      S.value = !1, K ? n("complete", Z, z.value) : (n("environment-created-no-switch", Z), p.value = "landing");
    }
    function ce() {
    }
    Ze(async () => {
      if (o.detectedModelsDir && (V.value = o.detectedModelsDir), o.workspacePath && (z.value = o.workspacePath), h.value === 2) {
        ...
        await Re(), clearTimeout(Z), T.value = !1;
      }
    });
    async function Re() {
      try {
        ...
        if (console.log("[ComfyGit] Create progress check:", Z.state, Z), Z.state === "creating") {
          console.log("[ComfyGit] Resuming in-progress environment creation:", Z.environment_name), p.value = "create", Ee.value = !0, re.value = Z.environment_name || "my-new-env", He.value = {
      ...
      try {
        const Z = await m();
        console.log("[ComfyGit] Import progress check:", Z.state, Z), Z.state === "importing" && (console.log("[ComfyGit] Resuming in-progress import:", Z.environment_name), N.value = {
    ...
    async function Ce() {
      ...
      const K = async () => {
        if (ye.value && Date.now() - ye.value > ql)
          return Z && clearInterval(Z), Ee.value = !1, U.value = "Environment creation timed out. Check server logs for details.", !1;
        try {
          const ge = await d();
          if (We.value = 0, ge.state === "idle" && Ee.value)
            return Z && clearInterval(Z), Ee.value = !1, U.value = "Environment creation was interrupted. Please try again.", !1;
          if (He.value = {
            progress: ge.progress ?? 0,
            message: ge.message,
            phase: ge.phase
          }, ge.state === "complete") {
            Z && clearInterval(Z), Ee.value = !1;
            const F = ge.environment_name || re.value;
            return n("complete", F, z.value), !1;
          } else if (ge.state === "error")
            return Z && clearInterval(Z), Ee.value = !1, U.value = ge.error || "Environment creation failed", !1;
          return !0;
        } catch (ge) {
          return We.value++, console.warn(`Polling failure ${We.value}/${no}:`, ge), We.value >= no ? (Z && clearInterval(Z), Ee.value = !1, U.value = "Lost connection to server. Please refresh and try again.", !1) : !0;
        }
      };
    ...
    return (Z, K) => (a(), c(j, null, [
      C(gt, {
        ...
        "show-close-button": !1,
        "close-on-overlay-click": !1,
        onClose: K[15] || (K[15] = (Te) => Z.$emit("close"))
      }, {
        header: g(() => [
          ...
          t("div", eI, [
            ...
            t("button", {
              class: "icon-btn",
              onClick: K[1] || (K[1] = (Te) => Z.$emit("close")),
              title: "Close"
            }, [...K[18] || (K[18] = [
              t("svg", {
                width: "16",
  ...
  setup(e, { emit: s }) {
    ...
    async function F(se) {
      ...
      ce(G), Pe.status === "success" ? (ne(`Branch "${se}" created`, "success"), await Z()) : ne(Pe.message || "Failed to create branch", "error");
    }
    async function D(se, G = !1) {
      const Pe = async (Ve) => {
        ...
        try {
          ...
          ce(st), Mt.status === "success" ? (ne(`Branch "${se}" deleted`, "success"), await Z()) : (ft = Mt.message) != null && ft.includes("not fully merged") ? ae.value = {
    ...
    async function ee(se) {
      ...
      if (G) {
        ...
        ce(Pe), Ve.status === "success" ? (ne(`Branch "${G}" created from ${se.short_hash}`, "success"), await Z()) : ne(Ve.message || "Failed to create branch", "error");
      }
    }
    function Me() {
      ...
      _e || (_e = window.setInterval(async () => {
        try {
          ...
          Xe.value = {
            ...
            progress: Pe,
            message: ft
          }, se.state === "complete" ? (Gt(), Ts(), Ee.value = !1, ne(`✓ Switched to ${Le.value}`, "success"), await Z(), Le.value = "") : se.state === "rolled_back" ? (Gt(), Ts(), Ee.value = !1, ne("Switch failed, restored previous environment", "warning"), Le.value = "") : se.state === "critical_failure" && (Gt(), Ts(), Ee.value = !1, ne(`Critical error during switch: ${se.message}`, "error"), Le.value = "");
        } catch (se) {
    ...
    async function _o(se) {
      ue.value = !1, await Z(), ne(se.message, se.success ? "success" : "error");
    }
    async function ko() {
      de.value = !1;
      ...
      try {
        ...
        if (ce(se), G.status === "success") {
          ...
          ne(`✓ Environment synced${Ve}`, "success"), await Z();
        } else {
    ...
    async function $o(se) {
      ...
      try {
        const Pe = await $(se);
        Pe.failed.length === 0 ? ne(`✓ Repaired ${Pe.success} workflow${Pe.success === 1 ? "" : "s"}`, "success") : ne(`Repaired ${Pe.success}, failed: ${Pe.failed.length}`, "warning"), await Z();
      } catch (Pe) {
    ...
    async function he() {
      ...
      try {
        ...
        if (ce(se), Ve.status === "success") {
          ...
          ne(`✓ Environment repaired${ft}`, "success"), (G = be.value) == null || G.closeDetailModal(), await Z();
        } else {
    ...
    async function X(se, G) {
      ne(`Environment '${se}' created`, "success"), await Z(), R.value && await R.value.loadEnvironments(), G && await vt(se);
    }
    async function Ge(se) {
      var G;
      ...
      ae.value = {
        ...
        onConfirm: async () => {
          ...
          try {
            const Pe = await _(se);
            Pe.status === "success" ? (ne(`Environment "${se}" deleted`, "success"), await Z(), R.value && await R.value.loadEnvironments()) : ne(Pe.message || "Failed to delete environment", "error");
          } catch (Pe) {
